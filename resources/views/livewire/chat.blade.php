        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <!-- Polling to keep checking for new messages -->
                    <div wire:poll>
                        <div class="chat-container overflow-auto" id="chat-container" style="max-height: 500px;">
                            @foreach ($messages as $message)
                                <div class="chat @if($message->from == auth()->id()) chat-end @else chat-start @endif">
...
<script>
    document.addEventListener('livewire:load', function () {
        // Hook to scroll down when a message is processed by Livewire
